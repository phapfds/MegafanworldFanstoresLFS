...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseDatabase
    {
        ...
        public static extern void GetRawData(string path, string objectName, string callback, string fallback);

        [DllImport("__Internal")]
        public static extern void ListenForNewMessages(string objectName, string messageData, string fallback);

        [DllImport("__Internal")]
        public static extern void PostFanroomData(string userid, string value, string objectName, string callback, string fallback);

        [DllImport("__Internal")]
        public static extern void GetFanroomData(string userid, string objectName, string callback, string fallback);


        [DllImport("__Internal")]
        public static extern void PushMessage(string senderNickname, string senderUserId, string text, string objectName, string callback, string fallback);


        [DllImport("__Internal")]
        public static extern void PostUserInfo(string email, string userID, string name, int coinsNum, int club, string objectName, string callback, string fallback);
